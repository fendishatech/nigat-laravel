...
@section('content')
    <div class="w-full px-10 flex items-center justify-center bg-slate-100">
        <form class="w-full my-8 rounded-lg bg-white" action="{{ url('/members/' . $member->id) }}" method="POST">
            @csrf
            @method('PATCH')
            ...
            <div class="px-12 pb-10">
                ...
                <div class="mb-4 flex items-center gap-6">
                    <div class="w-1/2">
                        ...
                        <div class="relative">
                            <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="text"
                                name="first_name" min="1" value="{{ old('first_name', $member->first_name) }}">
                    ...
                    <div class=" w-1/2">
                        ...
                        <div class="relative">
                            <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="text"
                                name="last_name" min="1" value="{{ old('last_name', $member->last_name) }}">
                ...
                <div class="mb-4 flex items-center gap-6">
                    <div class="w-1/2">
                        ...
                        <div class="relative">
                            <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="text"
                                name="email" min="1" value="{{ old('email', $member->email) }}">
                            @if ($errors->has('email'))
                    ...
                    <div class="w-1/2">
                        ...
                        <div class="relative">
                            <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="text"
                                name="phone_no" min="1" value="{{ old('phone_no', $member->phone_no) }}">
