        ...
        <form class="w-full my-8 rounded-lg bg-white" action="{{ url('/jobs') }}" method="POST">
            ...
            <div class="px-12 pb-10">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <textarea class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" name="description">{{ old('description') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <textarea class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" name="requirement">{{ old('requirement') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" type="number"
                            name="experience_months" value="{{ old('experience_months') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <textarea class="w-full px-4 py-2 pr-8 rounded shadow border border-gray-400" name="benefits">{{ old('benefits') }}</textarea>
